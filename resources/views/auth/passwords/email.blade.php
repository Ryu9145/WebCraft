...
<style>
    ...
    .forgot-card:hover .shape-top { width: 450px; height: 450px; top: -100px; left: -80px; border-radius: 63% 37% 54% 46% / 55% 48% 52% 45%; }
    .forgot-card:hover .shape-bottom { width: 450px; height: 450px; bottom: -100px; right: -80px; border-radius: 41% 59% 45% 55% / 59% 49% 51% 41%; }
    ...
    .forgot-card:hover .icon-wrapper {
        ...
        border-color: transparent; transform: scale(1.1) rotate(5deg); box-shadow: 0 15px 35px rgba(121, 40, 202, 0.4);
    }
    ...
    h1 { font-size: 24px; font-weight: 700; color: var(--navy-dark); margin-bottom: 10px; letter-spacing: -0.5px; }
    p { color: var(--text-muted); font-size: 13.5px; line-height: 1.6; margin-bottom: 25px; }

    input {
        background-color: #f8fafc; border: 1px solid #e2e8f0; padding: 12px 15px; margin-bottom: 5px; width: 100%; border-radius: 10px; font-size: 13.5px; color: var(--navy-dark); font-family: var(--font-family); font-weight: 500; transition: var(--smooth-transition);
    }
    ...
    .invalid-feedback { display: block; width: 100%; font-size: 11px; color: var(--danger); text-align: left; margin-bottom: 15px; padding-left: 5px; font-weight: 500; animation: slideDown 0.4s ease; }
    @keyframes slideDown { from { opacity: 0; transform: translateY(-5px); } to { opacity: 1; transform: translateY(0); } }

    button.primary-btn {
        border-radius: 50px; background-color: var(--navy-dark); color: var(--white); font-size: 13px; font-weight: 600; padding: 12px 45px; letter-spacing: 0.5px; border: 1px solid transparent; cursor: pointer; width: 100%; margin-bottom: 20px; margin-top: 10px; transition: var(--smooth-transition); background-size: 200% auto;
    }
    ...
    .alert-success-custom { background-color: #ecfdf5; color: #047857; padding: 12px; border-radius: 12px; font-size: 12px; font-weight: 600; margin-bottom: 20px; display: flex; align-items: center; justify-content: center; animation: slideDown 0.4s ease; border: 1px solid #a7f3d0; }

    .back-link { color: var(--text-muted); font-size: 13px; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; transition: 0.3s; }
